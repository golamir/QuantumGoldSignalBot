...
SCALP_MIN_CANDIDATE_SCORE = 58
SCALP_MIN_AI_SCORE = 70
SCALP_MIN_QUALITY_SCORE = 65
SCALP_MIN_ADX = 15
SCALP_STRONG_ADX = 22
SCALP_MIN_M1_SCORE = 55
SCALP_MIN_M5_SCORE = 55
SCALP_MIN_MICRO_SCORE = 52
SCALP_MIN_MONEY_SCORE = 60
...
def master_quality_filter(
    ...
    if SCALP_SUB100_ENABLED:
        ...
        if (scalp.get("m1_score",0) < SCALP_MIN_M1_SCORE or scalp.get("m5_score",0) < SCALP_MIN_M5_SCORE) and fusion_score < 72:
            return False, "M1/M5 trigger confirmation too weak"
        if micro_score < SCALP_MIN_MICRO_SCORE and money_score < SCALP_MIN_MONEY_SCORE and fusion_score < 72:
            return False, "Need Microstructure or Money Structure confirmation"
        if not trend_aligned and fusion_score < 72:
            return False, "M1/M5 trend conflict"
        if not rsi_valid and fusion_score < 72:
    ...
    try:
        ...
        if SCALP_SUB100_ENABLED:
            ...
            if news_risk == "HIGH":
                ...
                return None
            if not trend_aligned and fusion.get("score", 0) < 72:
...
async def main():
    ...
    print("FAST SCALP MODE: ENABLED | M1 trigger + M5 primary context | soft over-filter protection")
